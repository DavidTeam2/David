...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DavidtEaM/Files_David/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DavidtEaM/Files_David/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DavidtEaM/Files_David/main/File_Bot/games.lua") 
...
send(msg.chat_id_, msg.id_,'᥀︙جارٍ الان تحديث السورس الى اخر اصدار')
os.execute('rm -rf David.lua')
os.execute('wget https://raw.githubusercontent.com/DavidtEaM/David/main/David.lua')
send(msg.chat_id_, msg.id_,'᥀︙تم تحديث السورس \n᥀︙لديك اخر اصدار لسورس ديفد\n᥀︙الاصدار » { v 2.6 }')
dofile('David.lua')  
end
if text == 'تحديث المتجر' and DevDavid(msg) then 
...
if DevDavid(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DavidtEaM/Files_David/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DavidtEaM/Files_David/main/File_Bot/"..file)
if res == 200 then
